...
export const updateUser = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    const { email, name, family_name } = req.body;  // Extract updated user data from the body
...
export const avatorUpload = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    // const id  = req.userId;
    console.log(req.body);
    const id = req.body.user_id;
